...
with open('/home/chen/Downloads/CSE421/assign_seat/CSE490/available_seat_numbers.csv', 'r') as fcr:
	line =fcr.readline()
	cnt=1
	while line:
		#print line
...
with open('/home/chen/Downloads/CSE421/assign_seat/CSE490/out_bb_user_w_seat.csv','w')as out:
	with open('/home/chen/Downloads/CSE421/assign_seat/CSE490/490_bb_info.csv', 'r') as fbb:
		line =fbb.readline()
		cnt=1
		while line:
			if cnt>1:	
